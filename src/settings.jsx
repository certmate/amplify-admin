    ...
    ['/certs']: {
        ...
        form: {
            schema: {
                ...
                auditSections: { label: 'Sections', table: { columnProps: { width: 400 }, component: (data, record) => <CustomComponent.AuditSections data={data} />}, validation: array().min(2), formComponent: { component: data => <CustomComponent.CreateAuditSections {...data} /> } },

...
export const deriveComponent = (type, data) => {
    switch (type) {
        case "image":
            return data ? <StorageImage height={100} width={100} onClick={e => window.open(e.target.src, '_blank')} onStorageGetError={error => console.log(error)} imgKey={data} fallbackSrc="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" accessLevel="public" /> : <img height={100} width={100} src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" />
